...
The counterfinding is material for the Unicode question at this stage: this pass found no positive example of an established compact response glyph being used as a portable plain-text interchange character. Existing visual workarounds rely on product images or dedicated icon fonts, including [DSSSP](https://github.com/NumberOneBot/dsssp/blob/main/src/icons/font.css) and [FontAudio](https://github.com/fefanto/fontaudio) (EV-005, EV-025).
